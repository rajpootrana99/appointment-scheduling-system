                        ...
                        <div class="widget-profile pro-widget-content">
                            <div class="profile-info-widget">
                                <a href="#" class="booking-doc-img">
                                    <img src="<?php echo e(asset('storage/'.\Illuminate\Support\Facades\Auth::user()->image)); ?>" alt="User Image">
                                </a>
                                <div class="profile-det-info">
                                    ...
                                    <div class="patient-details">
                                        <h5 class="mb-0">
                                            <?php echo e(\Illuminate\Support\Facades\Auth::user()->lawyerInformation->education); ?>, <?php echo e(\Illuminate\Support\Facades\Auth::user()->lawyerInformation->lawyerType->name); ?></h5>
                                    </div>
                                </div>
                            </div>
                        </div>

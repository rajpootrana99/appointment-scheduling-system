										...
										<div class="card-body">
											...
											<div class="row">
												<div class="col-md-10 col-lg-6">
													<form method="post" action="<?php echo e(route('profile.updatePassword', ['profile' => Auth::user()])); ?>">
                                                        <?php echo method_field('PATCH'); ?>
                                                        <?php echo csrf_field(); ?>
														<div class="form-group">
														...
														<div class="form-group">
                                                            ...
                                                            <div style="color: #ff0000; font-size: x-small"><?php echo e($errors->first('new_password')); ?></div>
														</div>
														<div class="form-group">
															<label>Confirm Password</label>
															<input type="password" name="password_confirmation" class="form-control">
                                                            <div style="color: #ff0000; font-size: x-small"><?php echo e($errors->first('password_confirmation')); ?></div>
														</div>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Workspace\appointment-scheduling-system\resources\views/admin/profile/index.blade.php ENDPATH**/ ?>
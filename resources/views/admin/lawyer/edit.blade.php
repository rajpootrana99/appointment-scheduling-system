    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <form method="post" action="{{ route('lawyerInformation.update', ['lawyerInformation' => $lawyerInformation]) }}" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                                ...
                                <div class="row form-row">
                                    <div class="col-6 col-sm-6">
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input type="text" name="name" value="{{ $lawyerInformation->user->name }}" class="form-control">
                                    ...
                                    <div class="col-6 col-sm-6">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" name="email" value="{{ $lawyerInformation->user->email }}" readonly class="form-control">
                            ...
                            <div class="card-body">
                                <div class="row form-row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="lawyer_type_id" class="form-control">
                                                @foreach($lawyerTypes as $lawyerType)
                                                    <option value="{{ $lawyerType->id }}"{{ $lawyerInformation->lawyer_type_id == $lawyerType->id ? 'selected' : '' }}>{{ $lawyerType->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-6 col-sm-6">
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <input type="text" name="phone" value="{{ $lawyerInformation->user->phone }}" class="form-control">
                                    ...
                                    <div class="col-6 col-sm-6">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input type="text" name="address" value="{{ $lawyerInformation->address }}" class="form-control">
                                    ...
                                    <div class="col-6 col-sm-6">
                                        <div class="form-group">
                                            <label>City</label>
                                            <input type="text" name="city" value="{{ $lawyerInformation->city }}" class="form-control">
                                    ...
                                    <div class="col-6 col-sm-6">
                                        <div class="form-group">
                                            <label>CNIC</label>
                                            <input type="number" name="cnic" value="{{ $lawyerInformation->cnic }}" class="form-control">
                                            <div style="color: #ff0000; font-size: small;" class="mt-2">{{ $errors->first('cnic') }}</div>
                                        </div>
                                    </div>
                                    <div class="col-6 col-sm-6">
                                        <div class="form-group ml-1">
                                            <img id="output" width="100" height="100" src="{{ asset('storage/'.$lawyerInformation->user->image) }}" class="justify-content-center" alt="">
                                            <div class="form-group">
                                ...
                                <div class="row form-row">
                                    <div class="col-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="education" value="{{ $lawyerInformation->education }}" class="form-control">
                                    ...
                                    <div class="col-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="passing_year" value="{{ $lawyerInformation->passing_year }}" class="form-control">
